...
<html>
    ...
    //Locations visited
    echo "<br><br><span class='header'>Stores Visited</span>";
    $sql = "SELECT DISTINCT Location.Name FROM Location, (
    	SELECT LocationID FROM Order_Has_Item, MyOrder WHERE DriverID = '$myid' AND MyOrder.OrderID = Order_Has_Item.OrderID AND Time_End IS NOT NULL) AS L
